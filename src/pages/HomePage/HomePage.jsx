...
export default function HomePage() {
  return (
    <div class="flex flex-col items-center justify-center h-screen bg-gray-100">
      <h1 class="text-4xl font-bold mb-8 text-blue-500 text-2xl">Welcome to BTY</h1>
      <div class="w-2/3 text-xl mb-8 text-center">
      ...
      <Link to="/authpage" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">GET STARTED</Link>
    </div>

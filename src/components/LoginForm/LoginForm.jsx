...
export default function LoginForm({ setUser }) {
  ...
  return (
    <div>
      <div>
        <h1 className="text-blue-500 text-2xl">LOG IN</h1>
        <div className="container mx-auto py-8">
          <form className="w-full max-w-sm mx-auto bg-white p-8 rounded-md shadow-md" autoComplete="off" onSubmit={handleSubmit}>
            ...
            <br></br>
            <br></br>
            <button className="w-full bg-blue-500 text-white text-sm font-bold py-2 px-4 rounded-md hover:bg-blue-600 transition duration-300" type="submit">LOG IN</button>
          </form>
        </div>
